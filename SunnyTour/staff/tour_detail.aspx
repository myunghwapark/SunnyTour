<%@ Page Title="" Language="C#" MasterPageFile="~/Staff.Master" AutoEventWireup="true" CodeBehind="tour_detail.aspx.cs" Inherits="SunnyTour.WebForm12" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main class="cd-main-content">
	    <center>
	        <div class="content_div">
	            <div class="title" style="text-align:center;">Tour Detail</div>
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td colspan="2" style="text-align:right;border-top:0;">
                                <asp:Button ID="btnDelete" runat="server" Text="Delete" Class="btn btn-secondary" OnClick="btnDelete_Click" OnClientClick="return confirm('Are you sure you want to delete?')" CausesValidation="False"></asp:Button>
                                <asp:Button ID="btnSave" runat="server" Text="Save" Class="btn btn-info" OnClick="btnSave_Click"></asp:Button>
                            </td>
                        </tr>
                        <tr>
                            <th>Tour No</th>
                            <td colspan="2"><asp:Label ID="labelTourSeqNo" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <th>Tour Title</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtImageUrl" runat="server" class="form-control"></asp:TextBox>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <th>Description</th>
                            <td><asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" class="form-control" style="height:100px;"></asp:TextBox></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th>Tour Status</th>
                            <td><asp:DropDownList ID="dropDownList_tourStatus" runat="server" AutoPostBack="True" class="form-control">
                                </asp:DropDownList>
                            </td>
                            <td></td>
                        </tr>
